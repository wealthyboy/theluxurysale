...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        ...
        <div class="card">
            <form id="register" method="POST" action="/admin/users/{{ optional($user)->id }}" aria-label="">
                @csrf
                @method('PATCH')
                    ...
                    <div class="card-content">
                        <div class="input-group">
                            ...
                            <div class="form-group label-floating">
                                ...
                                <input id="first_name" required="true" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="first_name" value="{{ optional($user)->name }}" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-group label-floating">
                                ...
                                <input id="last_name" required="true" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="last_name" value="{{ optional($user)->last_name }}" autofocus>
                            </div>
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
                            ...
                            <div class="form-group label-floating">
                                ...
                                <input id="email" required="true" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ optional($user)->email }}">
                            </div>
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
