            ...
            <div class="shipping-address-info">
              ...
              <p class="mt-3 mb-3">
                <a
                  ...
                  data-placement="left"
                  href="#"
                  class="ml-0 mr-4 color--primary bg--gray l-f1  p-3 border "
                >
                ...
                <a
                  ...
                  data-placement="left"
                  href="#"
                  class="mr-4 l-f1  bg--gray   p-3 color--primary ml-4   make-default"
                >
...
export default {
  ...
  methods: {
    ...
    getState: function (evt) {
      let value = typeof evt.target !== null ? evt.target.value : null;
