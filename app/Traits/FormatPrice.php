  ...
  public function display_price()
  {
    ...
    if ($this->formatted_discount_price() !== null) {
      if ($this->product_type == 'variable') {
        echo "<i style='text-decoration: line-through;'>" . number_format($this->variant->price) . "</i>" . '  ' . number_format($this->variant->sale_price);
      } else {
        echo  "<i style='text-decoration: line-through;'>" . number_format($this->price) . "</i>" . '  ' . number_format($this->sale_price);
      }
    } else {
      if ($this->product_type == 'variable') {
        echo  number_format(optional($this->variant)->price);
      }
